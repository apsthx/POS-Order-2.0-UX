...
function modaleditpassword() {
    url = service_base_url + 'profilecustomer/modaleditpassword';
    ...
    if ($("#oldpassword").val() != '') {
        if ($("#newpassword").val() != '') {
            if ($("#confirmpassword").val() != '') {
                ...
                url = service_base_url + 'profilecustomer/editpassword';
                $.ajax({
                    url: url,
                    method: "POST",
                    data: {
                        customer_id_pri: $('#customer_id_pri_password').val(),
...
function upload_image() {
        ...
        url = service_base_url + 'profilecustomer/upload_image';
        $('body').loading();
        $.ajax({
            url: url,
            dataType: "json",

...
function data_report() {
    ...
    url = service_base_url + 'reporttransportdelivery/data';
    $('body').loading();
    $.ajax({
        url: url,
        method: "POST",
...
function excel() {
    ...
    url = service_base_url + 'reporttransportdelivery/export/'+date_start_report+'/'+date_end_report+'/'+transport_service_id;

...
function data() {
    ...
    url = service_base_url + 'reportsummaryproduct/data';
    $('body').loading();
    $.ajax({
        url: url,
        method: "POST",
...
function excel() {
    ...
    //console.log(dateday+'/'+datemonth+'/'+dateyear+'/'+datedaystart+'/'+datedayend);
    url = service_base_url + 'reportsummaryproduct/export/'+checked+'/'+dateday+'/'+datemonth+'/'+dateyear+'/'+datedaystart+'/'+datedayend+'/'+customer_group_id;

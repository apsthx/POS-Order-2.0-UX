            ...
            if ($datas->num_rows() > 0) {
                foreach ($datas->result() as $data) {
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="vertical-align: middle;"><?php echo number_format($data->product_buy_price, 2); ?></td>
                        ...
                        <td class="text-center" style="vertical-align: middle;">
                            ...
                            if (sizeof($product_id_arr) > 0) {
                                if (!in_array($data->product_id, $product_id_arr)) {
                                    ...
                                    <input type="checkbox" id="product_checkbox_modal_<?php echo $i; ?>" value="0" onclick="checkbox_product(this, '<?php echo $data->product_id; ?>', '<?php echo $data->product_name; ?>', '<?php echo $data->product_buy_price; ?>', '<?php echo $data->product_unit; ?>',<?php echo $i; ?>);" >

...
<form id="form-receipt" action="<?php echo base_url() . 'selllist/print_receipt'; ?>" target="_blank" onsubmit="return submit_receipt();" method="post">
            ...
            <tbody>
                ...
                if ($datas->num_rows() > 0) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><span class="<?php echo ($data->status_receipt_id == 1) ? 'badge badge-success' : 'badge badge-danger'; ?>"><i class="<?php echo ($data->status_receipt_id == 1) ? 'fa fa-check-circle' : 'fa fa-times-circle-o'; ?>"></i> <?php echo $this->selllist_model->ref_status_receipt($data->status_receipt_id)->row()->status_receipt_name; ?></span></td>    
...
<div class="modal fade" id="modal_receipt_cancel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-trash"></i>&nbsp;ยกเลิกรายการขายหน้าร้าน</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>

            <form action="<?php echo base_url() . 'selllist/cancel'; ?>" onsubmit="return submit_cencel_receipt();" method="post" >

        ...
        if ($datas->num_rows() > 0) {
            foreach ($datas->result() as $data) {
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $this->reportinvoice_model->ref_status_pay($data->status_pay_id)->row()->status_pay_name; ?></td>
                    <td class="text-center"><?php echo $this->reportinvoice_model->ref_status_transfer($data->status_transfer_id)->row()->status_transfer_name; ?></td>
                     <td class="text-center"><?php echo $this->reportinvoice_model->ref_status_receipt_order($data->status_receipt_order_id)->row()->status_receipt_order_name; ?></td>

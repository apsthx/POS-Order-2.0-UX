                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="hidden" name="type_receipt_id" value="2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="sale_from_id" class="form-control form-control-sm">
                                            ...
                                            <?php
                                            $sale_from = $this->quotation_model->get_sale_from();
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="customer_tel" id="customer_tel" value="<?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_tel : ''; ?>" required="" placeholder="ต้องกรอกเบอร์มือถือ 10 ตัวอักษรเท่านั้น เช่น 0981845123" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="customer_address" id="customer_address" class="form-control form-control-sm" rows="1"><?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_address : ''; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="customer_district" id="customer_district" value="<?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_district : ''; ?>" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="customer_amphoe" id="customer_amphoe" value="<?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_province : ''; ?>" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="customer_province" id="customer_province" value="<?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_province : ''; ?>" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="customer_zipcode" id="customer_zipcode" value="<?php echo ($receipt_edit != NULL) ? $receipt_edit->customer_zipcode : ''; ?>" class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 table-responsive">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody id="detail_tr">
                                    ...
                                    <?php
                                    if ($receipt_edit != NULL) {
                                        $receipt_detail = $this->quotation_model->get_detail($receipt_edit->receipt_master_id_pri);
                                        if ($receipt_detail->num_rows() > 0) {
                                            ...
                                            foreach ($receipt_detail->result() as $detail) {
                                                ...
                                                <tr id='tr_id_<?php echo $i; ?>'>
                                                    ...
                                                    <td><input name="product_id[]" id="product_id_<?php echo $i; ?>" value="<?php echo $detail->product_id; ?>" onchange="get_product_by_id(this, '<?php echo $i; ?>')" type="text" class="form-control form-control-sm product_id" autofocus="" onkeypress="if (event.keyCode === 13) {
                                                    ...
                                                    <td class="text-left bg-white">
                                                        <button type="button" class="bt-open-modal-product btn btn-link" onclick="delete_detail('<?php echo $i; ?>');">
                                            ...
                                            <tr id='tr_id_<?php echo $i; ?>'>
                                                <td class="text-right"><?php echo $i; ?></td>
                                                <td><input name="product_id[]" id="product_id_<?php echo $i; ?>" onchange="get_product_by_id(this, '<?php echo $i; ?>')" type="text" class="form-control form-control-sm product_id" autofocus="" onkeypress="if (event.keyCode === 13) {
                                                            get_product_by_id(this, '<?php echo $i; ?>');
                                                            add_detail();
                                                        }" /></td>
                                                <td><input name="product_name[]" id="product_name_<?php echo $i; ?>" type="text" class="form-control form-control-sm" readonly="" /></td>
                                                <td><input name="product_amount[]" id="product_amount_<?php echo $i; ?>" type="number" onchange="change_number(this, '<?php echo $i; ?>')" class="form-control form-control-sm text-right"  readonly="" /></td>
                                                <td><input name="product_unit[]" id="product_unit_<?php echo $i; ?>" type="text" class="form-control form-control-sm text-right" readonly="" /></td>
                                                <td><input name="product_price[]" id="product_price_<?php echo $i; ?>" type="number" onchange="change_number(this, '<?php echo $i; ?>')" class="form-control form-control-sm text-right"  readonly="" /></td>
                                                <td><input name="product_save[]" id="product_save_<?php echo $i; ?>" type="number" onchange="change_number(this, '<?php echo $i; ?>')" class="form-control form-control-sm text-right"  readonly="" /></td>
                                                <td><input name="product_price_sum[]" id="product_price_sum_<?php echo $i; ?>" type="text" class="form-control form-control-sm text-right" readonly="" /></td>
                                                <td class="text-left bg-white">
                                                    <button type="button" class="bt-open-modal-product btn btn-link" onclick="delete_detail('<?php echo $i; ?>');">
                                                        <i class="fa fa-times"></i>
                                                    </button>
                                    ...
                                    <tr id='tr_id_1'>
                                        ...
                                        <td><input name="product_id[]" id="product_id_1" onchange="get_product_by_id(this, '1')" type="text" class="form-control form-control-sm product_id" autofocus="" onkeypress="if (event.keyCode === 13) {

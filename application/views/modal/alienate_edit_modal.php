...
<div class="modal-body">
    ...
    <form method="post" id="form-edit" action="<?php echo base_url() . 'alienate/edit'; ?>" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <input type="text" name="invoice" value="<?php echo $data->invoice; ?>" class="form-control" >
            </div>
        </div>
        <p/>
        <div class="row">
        ...
        <p/>
        <div class="row">
            <label class="col-md-3 control-label text-right">สถานะตวจสอบ</label>
            <div class="col-md-8">
                <select name="status_inform_id" class="form-control">
                    ...
                    foreach ($status_inform->result() as $row) {
                        ?>
                        <option <?php echo ($data->status_inform_id == $row->status_inform_id) ? 'selected' : ''; ?> value="<?php echo $row->status_inform_id; ?>"><?php echo $row->status_inform_name; ?></option>
                        <?php
                    }
                    ?>
                </select>

...
<div class="modal-body">
    <div class="bootbox-body">
        <form class="form-material m-t-10 form-parsley" method="post" action="<?php echo base_url() . 'wallet/edit'; ?>" autocomplete="off">

            <input type="hidden" name="bank_id" value="<?php echo $row->bank_id; ?>">

            <div class="form-group">
                <label>เลขที่บัญชี</label>
                <input type="text" name="bank_number" value="<?php echo $row->bank_number; ?>" class="form-control">
            </div>
            <div class="form-group">
                <label>ธนาคาร</label>
                <input type="text" name="bank_name" value="<?php echo $row->bank_name; ?>" class="form-control" required>
            </div>
            <div class="form-group">
                <label>ชื่อเจ้าของบัญชี</label>
                <input type="text" name="bank_fullname" value="<?php echo $row->bank_fullname; ?>" class="form-control" >
            </div>
            <div class="form-group">

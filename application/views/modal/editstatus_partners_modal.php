<div class="modal-header">
    <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;ระงับคู่ค้า</h4>
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
</div>
<div class="modal-body">
    <div class="bootbox-body">
        <form class="form-material m-t-10" method="post" onsubmit="return editstatus();" autocomplete="off">
            <input type="hidden" name="partners_id_pri" id='partners_id_pri' value="<?php echo $partners_id_pri ;?>">
            <b><p class="text-danger text-center"><i class='fa fa-close'></i> ต้องการระงับคู่ค้า</p></b>
            <br/>

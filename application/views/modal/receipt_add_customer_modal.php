...
<div class="modal-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            ...
            <input type="text" id="customer_id_add" value="<?php echo $number_id; ?>" class="form-control" disabled="" required="">
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <select id="customer_group_id_add" class="form-control">
                <?php foreach ($this->quotation_model->get_groupcustomer()->result() as $data) { ?>
    ...
    function add_customer_submit() {
        ...
        if (fullname != "") {
            ...
            $.ajax({
                ...
                success: function ()
                {
                    var url_cat = service_base_url + 'quotation/get_customer_group_json';
                    $.ajax({
                        url: url_cat,
                        dataType: "JSON",
                        method: "POST",

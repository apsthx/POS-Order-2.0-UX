                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control form-control-sm col-sm-5" id="datemonth">
                                <?php  $shop_id = $this->accesscontrol->getMyShop()->shop_id;
                                foreach ($this->reportinvoicesub_model->receipt_year($shop_id)->result() as $yearmonth) { ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control form-control-sm col-sm-5" id="dateyear">
                                <?php foreach ($this->reportinvoicesub_model->receipt_year($shop_id)->result() as $year) { ?>

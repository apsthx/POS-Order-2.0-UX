            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="text-right col-5">
                        <input type="checkbox" class="col-sm-6 offset-sm-2" id="checkboxstatus_order" value="1" onchange="data();">
                        <label for="checkboxstatus_order"> แสดงรายการที่ออกใบเสร็จแล้ว</label>
                        <input type="checkbox" class="col-sm-6 offset-sm-2" id="checkboxstatus" value="1" onchange="data();">

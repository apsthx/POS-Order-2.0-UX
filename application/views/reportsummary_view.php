                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control form-control-sm col-sm-5" id="datemonth">
                                <?php foreach ($this->reportsummary_model->receipt_year()->result() as $yearmonth) { ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control form-control-sm col-sm-5" id="dateyear">
                                <?php foreach ($this->reportsummary_model->receipt_year()->result() as $year) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-left">                           
                            <select id="customer_group_id" class="form-control form-control-sm">
                                ...
                                <?php foreach ($this->reportsummary_model->ref_customer_group()->result() as $customer_group) { ?>

...
<div class="modal-body">
    <div class="bootbox-body">
        <form id="form_modal" class="form-material m-t-10" method="post" action="<?php echo base_url() . 'admin/settingsms/edit'; ?>" autocomplete="off">
            ...
            <div class="form-group">
                <label> จำนวนเครดิต sms ที่ส่งไป : </label>
            ...
            <div class="form-group">
                <label> จำนวนเครดิต sms คงเหลือ : </label>

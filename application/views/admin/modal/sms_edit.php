    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i>&nbsp;แก้ไขบริการ SMS</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div class="bootbox-body">
                    <form id="form_modal" class="form-material m-t-10" method="post" action="<?php echo base_url() . 'admin/package/editsms'; ?>" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="sms_name" id="sms_name" class="form-control" value="<?php echo $data->sms_name; ?>" required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> ราคา : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="sms_cost" id="sms_cost" value="<?php echo $data->sms_cost; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> จำนวนข้อความ : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="sms_amount" value="<?php echo $data->sms_amount; ?>" class="form-control"  required="">
                            </div>
                        </div>   

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i>&nbsp;แก้ไขแพ็กเกจ</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div class="bootbox-body">
                    <form id="form_modal" class="form-material m-t-10" method="post" action="<?php echo base_url() . 'admin/package/edit'; ?>" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="package_cost" id="package_cost" value="<?php echo $data->package_cost; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> ผู้ใช้ระบบ : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="package_useuser" id="package_useuser" value="<?php echo $data->package_useuser; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> สาขาย่อย : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="package_useshop" id="package_useshop" value="<?php echo $data->package_useshop; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> ตัวแทนจำหน่าย : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="package_useagent" id="package_useagent" value="<?php echo $data->package_useagent; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> Free SMS : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="package_sms" id="package_sms" value="<?php echo $data->package_sms; ?>" class="form-control"  required="">
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label class="col-sm-4 text-right control-label col-form-label"> จำกัดวัน : <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="number" name="package_usedate" id="package_usedate" value="<?php echo $data->package_usedate; ?>" class="form-control"  required="">
                            </div>
                        </div> 

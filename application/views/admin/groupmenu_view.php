        ...
        <div class="card">
            <div class="card-block">
                <h4 class="card-title"><i class="<?php echo $icon; ?>"></i> <?php echo " " . $title; ?> 
                    ...
                    <a href="<?php echo base_url() . 'admin/groupmenu/sortgroupmenu'; ?>" target="_blank" style="float: right" class="btn btn-sm btn-rounded btn-outline-inverse"><i class="fa fa-sort"></i> จัดเรียงกลุ่มเมนู</a>
                </h4>   
                                ...
                                foreach ($datas->result() as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url() . 'admin/groupmenu/menu/' . $data->group_menu_id; ?>" target="_blank" class="btn btn-sm btn-outline-warning"><i class="fa fa-list"></i> จัดการเมนู</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bootbox-body">
                    <form id="form-add" class="form-material m-t-10" method="post" action="<?php echo base_url() . 'admin/groupmenu/addgroupmenu'; ?>" autocomplete="off">
...
<script>
    ...
    function modaledit(group_menu_id) {
        url = service_base_url + 'admin/groupmenu/groupmenuedit';
    ...
    function modaldelete(group_menu_id) {
        ...
        url = service_base_url + 'admin/groupmenu/deletegroupmenu/' + group_menu_id;

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-block">
                ...
                <form class="form-material m-t-10" id="formedit" method="post" action="<?php echo base_url() . 'admin/email/edit'; ?>" autocomplete="off">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-block">
                <h4 class="card-title"><i class="fa fa-envelope-o"></i> <?php echo " SMS ใช้งาน"; ?></h4>  
                <form class="form-material m-t-10" id="formedit" method="post" action="<?php echo base_url() . 'admin/email/editsms'; ?>" autocomplete="off">
                    <?php $data = $this->email_model->get_setting_email(); ?>
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label> เบอร์ที่ใช้ส่ง : <span class="text-danger">*</span></label>
                            <input type="text" name="sms_tel" value="<?php echo $data->sms_tel ;?>" class="form-control form-control-line" data-parsley-error-message="กรุณากรอกข้อมูล"  required="">
                        </div> 
                        <div class="form-group col-sm-4">
                            <label> SMS User : <span class="text-danger">*</span></label>
                            <input type="text" name="sms_username" value="<?php echo $data->sms_username ;?>" class="form-control form-control-line" data-parsley-error-message="กรุณากรอกข้อมูล"  required="">
                        </div>

                        <div class="form-group col-sm-4">
                            <label> SMS Password : <span class="text-danger">*</span></label>
                            <input type="password" name="sms_password" value="<?php echo $data->sms_password ;?>" autocomplete="new-password" class="form-control form-control-line" data-parsley-error-message="กรุณากรอกข้อมูล"  required="">
                        </div> 
                    </div> 
                    <div class="form-group">
                        <div class="col-md-12 text-center">

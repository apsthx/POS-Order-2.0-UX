        ...
        <div class="card">
            <div class="card-block">
                <h4 class="card-title"><i class="<?php echo $icon; ?>"></i> <?php echo " " . $title; ?> 
                    ...
                    <a href="<?php echo base_url() . 'groupmenu/sortmenu/' . $group_menu_id; ?>" target="_blank" style="float: right" class="btn btn-sm btn-rounded btn-outline-inverse"><i class="fa fa-sort"></i> จัดเรียงเมนู</a>            
                </h4> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bootbox-body">
                    <form class="form-material m-t-10" method="post" action="<?php echo base_url() . 'groupmenu/addmenu'; ?>" autocomplete="off">

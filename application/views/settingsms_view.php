                                ...
                                foreach ($datas->result() as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-outline-info" onclick="modaledit(<?php echo $data->setting_sms_id; ?>)"><i class="fa fa-edit"></i> แก้ไข</button>                                         
                                            <!--<button type="button" class="btn btn-sm btn-outline-danger" onclick="modaldelete(<?php //echo $data->setting_sms_id; ?>);"><i class="fa fa-trash"></i> ลบ</button>-->
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bootbox-body">
                    <form class="form-material m-t-10" id="formadd" method="post" action="<?php echo base_url() . 'settingsms/add'; ?>" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="credit_all" class="form-control form-control-line" data-parsley-error-message="กรุณากรอกข้อมูล"  required="">
                        </div> 
                        <div class="form-group">

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-block">
                ...
                <form class="form-horizontal" id="formedit" method="post" action="<?php echo base_url() . 'profilecustomer/edit'; ?>" autocomplete="off">
                    <input type="hidden" name="customer_id_pri" id="customer_id_pri"  value="<?php echo $data->customer_id_pri; ?>">
                    <input type="hidden" name="customer_id" id="customer_id"  value="<?php echo $data->customer_id; ?>">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a  id="image_a" href="<?php echo base_url() . 'store/image/' . $this->profilecustomer_model->get_image($data->image_id)->image_name; ?>" target="_blank">
                                <img id="image_show" src="<?php echo base_url() . 'store/image/' . $this->profilecustomer_model->get_image($data->image_id)->image_name; ?>" width="100" height="100" style="cursor:pointer;">
                            </a>
                        </div>
                    </div>
                    <p/>

...
/**
 * Description of Reportproductmovement
 *
 * @Prasan Srisopa
 */
class Reportproductmovement extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('reportproductmovement_model');
    ...
    public function index() {
        $data = array(
            ...
            'js' => array('build/reportproductmovement.js'),
        );
        $this->renderView('reportproductmovement_view', $data);
    }
    ...
    public function data() {
        $data = array(
            ...
            'datas' => $this->reportproductmovement_model->product($this->input->post('search')),
        );
        $this->load->view('ajax/reportproductmovement_page', $data);
    }
    ...
    public function export($date_start, $date_end, $search) {
        ...
        $datas = $this->reportproductmovement_model->product($search);
